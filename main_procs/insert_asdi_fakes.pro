...
peakcalc,'normscifac.save',flux=flux_save,peaks=peaks
...
if (size(flux.fluximc))[1] ne (size(imc))[1] then begin
   print,"FLUX image and science image have different sizes. Please check why!"
   stop
endif
...
forprint2, rhos_fake, pas_fake, peaks_fake1, chanrats, dmags_fake,textout='inserted_fakes.txt',/silent,/update
