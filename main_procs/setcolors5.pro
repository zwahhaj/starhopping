pro setcolors5, img, paper = paper,nodisp=nodisp 
  device, decomposed=0
  ...
  sh = [0.57,0.73,1.0,0.5]*360.0 ;; start/end inten at each tertile
  ss = [0.78,0.74,0.5,0.0] ;; start/end inten at each tertile
  sv = [0.40,0.55,0.9,1.0] ;; start/end inten at each tertile
